...
import React$1, { CSSProperties, PropsWithChildren, ReactNode } from "react";
  ...
  export const FocusContext: import("react").Context<FocusController>;
  ...
  export function useElementFocusController(
  ...
  export const FocusBoundary: ({
    ...
    children,
    onFocusChange,
  }: React$1.PropsWithChildren<FocusBoundaryProps>) => JSX.Element;
  ...
  export const FocusDisabled: ({
    disabled,
    children,
  }: React$1.PropsWithChildren<FocusDisabledProps>) => JSX.Element;
  export enum UISound {
   ...
   * The component itself cannot be focused, it purely acts as a wrapper around a focusable child.
   */
  export const FocusKeyOverride: ({
    focusKey,
    children,
  }: React$1.PropsWithChildren<FocusKeyOverrideProps>) => JSX.Element;
  ...
  export const FocusNode: ({
    controller,
    children,
  }: React$1.PropsWithChildren<FocusNodeProps>) => JSX.Element;
  export const FocusRoot: ({
    children,
  }: React$1.PropsWithChildren) => JSX.Element;
  ...
  export const SelectableFocusBoundary: ({
    onSelectedStateChanged,
    children,
  }: React$1.PropsWithChildren<SelectableFocusBoundaryProps>) => JSX.Element;
  ...
  export function useLayoutMap(): Record<string, ControlPath>;
  ...
  export const ControlIcons: ({
    ...
    style,
    children,
  }: React$1.PropsWithChildren<ControlIconsProps>) => JSX.Element;
  ...
  export const ControlIcon: React$1.FC<ControlIconProps>;
  export function useInputControlIcon(binding: ControlPath): string | null;
  ...
  export const PointerBarrier: React$1.FC<PointerBarrierProps>;
  export const EventInputProvider: ({
    children,
  }: React$1.PropsWithChildren) => JSX.Element;
  export const GamepadPointerEventProvider: ({
    children,
  }: React$1.PropsWithChildren) => JSX.Element;
  export const NativeInputProvider: ({
    children,
  }: React$1.PropsWithChildren) => JSX.Element;
  export const navActions: InputAction[];
  export interface InputActionBarrierProps {
    includes?: InputAction[];
    excludes?: InputAction[];
    disabled?: boolean;
  }
  export const InputActionBarrier: React$1.NamedExoticComponent<
    React$1.PropsWithChildren<InputActionBarrierProps>
  >;
  ...
  export const InputActionConsumer: React$1.NamedExoticComponent<
  ...
  export const ExpandConsumer: ({
    expanded,
    expandable,
    disabled,
    children,
    onAction,
  }: React$1.PropsWithChildren<ExpandConsumerProps>) => JSX.Element;
  export interface InputActionEvent {
    action: InputAction;
    value: null | number | Number2;
  }
  export const inputActionNames$: ValueBinding<
    (keyof InputActionsDefinition)[]
  >;
  export const onInputActionPerformed$: EventBinding<InputActionEvent>;
  ...
  export const InputContext: React$1.Context<InputController>;
  ...
  export { GamepadButton$1 as GamepadButton };
