...
import { FC, FunctionComponent, MemoExoticComponent } from "react";
  ...
  export const Localized: LocComponent<LocalizedProps>;
  ...
  export const LocalizedDate: LocComponent<LocalizedDateProps>;
  export interface LocalizedDurationProps {
    value: number;
    daysPerYear: number;
    maxMonths?: number;
  }
  export const LocalizedDuration: LocComponent<LocalizedDurationProps>;
  ...
  export const LocalizedEntityName: FC<LocalizedNameProps>;
  ...
  export const LocalizedPercentage: LocComponent<LocalizedPercentageProps>;
