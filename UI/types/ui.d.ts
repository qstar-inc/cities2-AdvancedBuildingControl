...
import {
  ...
  export const DialogStack: import("react").Context<DialogStackProps>;
  ...
  type ButtonProps$1 = ButtonProps &
    Partial<LabeledIconButtonProps> & {
      variant?:
        | "flat"
        | "primary"
        | "round"
  ...
  export const InfoSection: ({
    ...
    className,
    children,
  }: PropsWithChildren<InfoSectionProps>) => JSX.Element;
  ...
  export const InfoSectionFoldout: ({
    header,
    initialExpanded,
    expandFromContent,
    focusKey,
    ...
    onToggleExpanded,
    children,
  }: PropsWithChildren<InfoSectionFoldoutProps>) => JSX.Element;
  ...
  export const FormattedParagraphs: ({
    ...
    splitLineLength,
    ...props
  }: PropsWithChildren<FormattedParagraphsProps>) => JSX.Element;
  export class MarkdownRenderer implements FormattedTextRenderer {
    render(str: string): FormattedTextRenderResult;
  }
